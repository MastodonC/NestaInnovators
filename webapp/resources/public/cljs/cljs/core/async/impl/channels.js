...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20851 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20851 = (function (val,box,meta20852){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20851.cljs$lang$type = true;
cljs.core.async.impl.channels.t20851.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20851";
cljs.core.async.impl.channels.t20851.cljs$lang$ctorPrWriter = (function (this__9947__auto__,writer__9948__auto__,opt__9949__auto__){return cljs.core._write.call(null,writer__9948__auto__,"cljs.core.async.impl.channels/t20851");
});
cljs.core.async.impl.channels.t20851.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20851.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20853){var self__ = this;
var _20853__$1 = this;return self__.meta20852;
});
cljs.core.async.impl.channels.t20851.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20853,meta20852__$1){var self__ = this;
var _20853__$1 = this;return (new cljs.core.async.impl.channels.t20851(self__.val,self__.box,meta20852__$1));
});
cljs.core.async.impl.channels.__GT_t20851 = (function __GT_t20851(val__$1,box__$1,meta20852){return (new cljs.core.async.impl.channels.t20851(val__$1,box__$1,meta20852));
});
}
return (new cljs.core.async.impl.channels.t20851(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_20854 = self__.takes.pop();if((taker_20854 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20854))
{var take_cb_20855 = cljs.core.async.impl.protocols.commit.call(null,taker_20854);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20855,taker_20854){
return (function (){return take_cb_20855.call(null,null);
});})(take_cb_20855,taker_20854))
);
} else
{}
{
