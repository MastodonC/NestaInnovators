...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20845 = 0;while(true){
var m_20846 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20846 == null))
{} else
{m_20846.call(null);
if((count_20845 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20847 = (count_20845 + 1);
count_20845 = G__20847;
continue;
}
} else
{}
