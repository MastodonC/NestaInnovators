...
{var pred__20717 = cljs.core._EQ_;var expr__20718 = limit;if(cljs.core.truth_(pred__20717.call(null,1,expr__20718)))
...
{var ch = s.charAt(index);var temp__4090__auto___20724 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___20724))
{var replacement_20725 = temp__4090__auto___20724;buffer.append([cljs.core.str(replacement_20725)].join(''));
} else
{buffer.append(ch);
}
{
var G__20726 = (index + 1);
index = G__20726;
continue;
}
}
