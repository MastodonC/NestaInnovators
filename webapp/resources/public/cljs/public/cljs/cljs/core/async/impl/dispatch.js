...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17756 = 0;while(true){
var m_17757 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17757 == null))
{} else
{m_17757.call(null);
if((count_17756 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17758 = (count_17756 + 1);
count_17756 = G__17758;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__9373__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__9373__auto__)
