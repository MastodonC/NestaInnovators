...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17727 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17727 = (function (val,box,meta17728){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17727.cljs$lang$type = true;
cljs.core.async.impl.channels.t17727.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17727";
cljs.core.async.impl.channels.t17727.cljs$lang$ctorPrWriter = (function (this__9947__auto__,writer__9948__auto__,opt__9949__auto__){return cljs.core._write.call(null,writer__9948__auto__,"cljs.core.async.impl.channels/t17727");
});
cljs.core.async.impl.channels.t17727.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17727.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17729){var self__ = this;
var _17729__$1 = this;return self__.meta17728;
});
cljs.core.async.impl.channels.t17727.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17729,meta17728__$1){var self__ = this;
var _17729__$1 = this;return (new cljs.core.async.impl.channels.t17727(self__.val,self__.box,meta17728__$1));
});
cljs.core.async.impl.channels.__GT_t17727 = (function __GT_t17727(val__$1,box__$1,meta17728){return (new cljs.core.async.impl.channels.t17727(val__$1,box__$1,meta17728));
});
}
return (new cljs.core.async.impl.channels.t17727(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9950__auto__,writer__9951__auto__,opts__9952__auto__){return cljs.core._write.call(null,writer__9951__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9947__auto__,writer__9948__auto__,opt__9949__auto__){return cljs.core._write.call(null,writer__9948__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17730 = self__.takes.pop();if((taker_17730 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17730))
{var take_cb_17731 = cljs.core.async.impl.protocols.commit.call(null,taker_17730);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17731,taker_17730){
return (function (){return take_cb_17731.call(null,null);
});})(take_cb_17731,taker_17730))
);
} else
{}
{
