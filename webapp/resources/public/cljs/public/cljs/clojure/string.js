...
{{
var G__18845 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18845;
continue;
}
} else
...
{var pred__18849 = cljs.core._EQ_;var expr__18850 = limit;if(cljs.core.truth_(pred__18849.call(null,1,expr__18850)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18849.call(null,2,expr__18850)))
...
var G__18852 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18853 = (limit__$1 - 1);
var G__18854 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18852;
limit__$1 = G__18853;
parts = G__18854;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___18856 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___18856))
{var replacement_18857 = temp__4090__auto___18856;buffer.append([cljs.core.str(replacement_18857)].join(''));
} else
{buffer.append(ch);
}
{
var G__18858 = (index + 1);
index = G__18858;
continue;
}
}
